...
boundaryConditions.SetNode(dependentField, CMISS.FieldVariableTypes.DELUDELN, 1,1,2,1,CMISS.BoundaryConditionsTypes.FIXED_INCREMENTED,-1.0)
boundaryConditions.SetNode(dependentField, CMISS.FieldVariableTypes.DELUDELN, 1,1,4,1,CMISS.BoundaryConditionsTypes.FIXED_INCREMENTED,-2.0)
boundaryConditions.SetNode(dependentField, CMISS.FieldVariableTypes.DELUDELN, 1,1,6,1,CMISS.BoundaryConditionsTypes.FIXED_INCREMENTED,-1.0)
boundaryConditions.SetNode(dependentField, CMISS.FieldVariableTypes.DELUDELN, 1,1,8,1,CMISS.BoundaryConditionsTypes.FIXED_INCREMENTED,-2.0)
...
exportFields.NodesExport("../Results/UniaxialLoadIncremTricubicHermite","FORTRAN")
exportFields.ElementsExport("../Results/UniaxialLoadIncremTricubicHermite","FORTRAN")
