...
boundaryConditions.SetNode(dependentField, CMISS.FieldVariableTypes.DELUDELN, 1,1,2,1,CMISS.BoundaryConditionsTypes.FIXED,-2.0)
boundaryConditions.SetNode(dependentField, CMISS.FieldVariableTypes.DELUDELN, 1,1,4,1,CMISS.BoundaryConditionsTypes.FIXED,-2.0)
boundaryConditions.SetNode(dependentField, CMISS.FieldVariableTypes.DELUDELN, 1,1,6,1,CMISS.BoundaryConditionsTypes.FIXED,-2.0)
boundaryConditions.SetNode(dependentField, CMISS.FieldVariableTypes.DELUDELN, 1,1,8,1,CMISS.BoundaryConditionsTypes.FIXED,-2.0)
...
exportFields.NodesExport("../Results/UniaxialLoadTricubicHermite","FORTRAN")
exportFields.ElementsExport("../Results/UniaxialLoadTricubicHermite","FORTRAN")
